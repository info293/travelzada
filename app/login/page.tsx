          ...
          <div className="hidden lg:block space-y-6 text-white">
            ...
            <div className="grid grid-cols-2 gap-3 mt-8">
              <div className="p-4 rounded-xl bg-white/10 backdrop-blur-md border border-white/20 hover:bg-white/15 transition-all duration-300">
                ...
                <h3 className="text-sm mb-1">Fast & Secure</h3>
                <p className="text-xs text-purple-100">Enterprise-grade security</p>
              </div>
              <div className="p-4 rounded-xl bg-white/10 backdrop-blur-md border border-white/20 hover:bg-white/15 transition-all duration-300">
                ...
                <h3 className="text-sm mb-1">Trusted</h3>
            ...
            <div className="bg-white/95 backdrop-blur-2xl rounded-3xl border border-white/20 shadow-2xl shadow-purple-900/50 p-6 md:p-8 relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <div className="text-center mb-6">
                  ...
                  <h2 className="text-2xl text-gray-900 mb-2 tracking-tight">Welcome Back</h2>
                  ...
                  <div className="flex items-center justify-between">
                    <label className="flex items-center group cursor-pointer">
                      <input
                        ...
                        onChange={handleChange}
                        className="w-4 h-4 text-purple-600 border-2 border-gray-300 rounded focus:ring-2 focus:ring-purple-500 focus:ring-offset-0 cursor-pointer transition-all"
                      />
