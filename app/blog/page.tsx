...
const featuredPosts = [
  {
    id: 1,
    title: 'The Eight Books That Built My Taste',
    subtitle: 'And why I loved each one',
    description: 'EIGHT BOOKS, VAMPIRE POLITICS, AND THE CASE FOR READING AGAINST TYPE',
    image: 'https://images.unsplash.com/photo-1488646953014-85cb44e25828?w=800&q=80',
    author: 'HARNIDH KAUR',
    date: 'NOV 11',
    category: 'HOW I BUILT MY TASTE',
  },
  {
    id: 2,
    title: 'Weekly Reading List: 08/11/2025',
    description: 'Things I Read This Week That Made Me Think',
    author: 'HARNIDH KAUR',
    date: 'NOV 8',
    likes: 17,
    comments: 1,
...
const mostPopularPosts = [
  ...
  {
    id: 4,
    title: 'Get Your Act Together, Kiddo',
    date: 'MAY 1',
    author: 'HARNIDH KAUR',
  ...
  {
    id: 8,
    title: 'The Courage to Walk Away',
    date: 'FEB 25',
    author: 'HARNIDH KAUR',
    image: null,
  },
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <Link href={`/blog/${featuredPosts[0].id}`} className="block group">
                <div className="mb-4">
                  <img
              ...
              <div className="space-y-4">
                ...
                <Link href={`/blog/${featuredPosts[1].id}`} className="block group">
