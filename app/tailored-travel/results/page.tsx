...
export default function TailoredResultsPage() {
        ...
        return (
            <main className="min-h-screen flex flex-col pt-16 md:pt-24 relative overflow-hidden bg-[#fafafa]">
                ...
                <div className="flex-1 flex flex-col items-center justify-center p-8 text-center relative z-10 w-full max-w-2xl mx-auto">
                    ...
                    <h1 className="text-2xl md:text-3xl font-normal text-gray-800 mb-4 tracking-tight text-balance">
                    ...
                    <div className="h-8 overflow-hidden relative w-full mb-10">
                        <AnimatePresence mode="wait">
                            <motion.p 
                                ...
                                className="text-base md:text-lg text-primary font-normal w-full absolute inset-x-0"
                            >
    ...
    return (
        <main className="h-[100dvh] lg:h-screen flex flex-col pt-16 md:pt-24 relative overflow-hidden bg-gray-50">
            ...
            <div className="flex-1 w-full max-w-[1600px] mx-auto p-3 sm:p-6 lg:p-8 flex flex-col min-h-0 overflow-hidden relative z-10 pb-4 md:pb-8">
                <div className="text-left mb-6 shrink-0 animate-fade-in-up flex items-center justify-between">
                    <div>
                        <h1 className="text-3xl md:text-4xl font-normal text-gray-900 mb-2 tracking-tight">
                ...
                {error ? (
                    <div className="w-full h-full bg-white rounded-3xl p-8 text-center shadow-xl border border-red-100 flex flex-col items-center justify-center animate-fade-in-up">
                        ...
                        <h2 className="text-2xl font-normal text-gray-900 mb-4">Oops! Something went wrong</h2>
                        <p className="text-gray-600 mb-8">{error}</p>
                        <button onClick={() => router.push('/tailored-travel')} className="bg-gray-900 text-white px-8 py-4 rounded-full font-normal hover:bg-gray-800 transition-colors shadow-lg">Try Again</button>
                    </div>
                ) : packages.length === 0 ? (
                    <div className="w-full h-full bg-white rounded-3xl p-8 text-center shadow-xl border border-gray-200 flex flex-col items-center justify-center animate-fade-in-up">
                        ...
                        <h2 className="text-2xl font-normal text-gray-900 mb-4">No Perfect Matches Found</h2>
                        ...
                        <button onClick={() => router.push('/tailored-travel')} className="bg-primary text-white px-8 py-4 rounded-full font-normal shadow-lg">Modify Preferences</button>
                    </div>
                ) : (
                    <>
                    {/* ====== MOBILE TAB SWITCHER ====== */}
                    <div className="lg:hidden flex bg-white rounded-full p-1.5 border border-gray-200 shadow-sm w-full max-w-sm shrink-0 mx-auto relative z-30 mb-4">
                        <button 
                            ...
                            className={`flex-1 flex justify-center items-center gap-2 py-2.5 text-sm font-normal rounded-full transition-all ${activeMobileTab === 'results' ? 'bg-gray-900 text-white shadow-md' : 'text-gray-500 hover:bg-gray-50'}`}
                        >
                        ...
                        <button 
                            ...
                            className={`flex-1 flex justify-center items-center gap-2 py-2.5 text-sm font-normal rounded-full transition-all ${activeMobileTab === 'chat' ? 'bg-gradient-to-r from-primary to-[#ff8a3d] text-white shadow-md' : 'text-gray-500 hover:bg-gray-50'}`}
                        >
                                        ...
                                        <motion.div variants={slideUpItem} className="bg-white/95 backdrop-blur-xl rounded-[2rem] overflow-hidden shadow-[0_12px_44px_rgba(0,0,0,0.08)] border border-gray-100 flex flex-col group relative shrink-0">
                                            ...
                                            <div className="relative h-44 md:h-52 w-full overflow-hidden shrink-0">
                                                ...
                                                <div className="absolute top-4 left-4 right-4 flex justify-between items-start z-10">
                                                    <div className="bg-black/60 backdrop-blur-md text-white px-3 py-1.5 rounded-full text-xs font-normal flex items-center gap-1.5 border border-white/20">
                                                    ...
                                                    <div className="bg-gradient-to-r from-[#ff8a3d] via-[#f85cb5] to-[#3abef9] p-[1px] rounded-full shadow-lg">
                                                        <div className="bg-white/95 backdrop-blur-md px-3 py-1 rounded-full flex items-center gap-1">
                                                            <span className="text-gray-900 font-normal text-xs"><span className="text-[#f85cb5]">✨</span> {pkg.matchScore}% Match</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="absolute bottom-4 left-5 text-white z-10 flex flex-col items-start gap-3">
                                                    <h3 className="text-2xl font-normal tracking-tight drop-shadow-md leading-tight pr-4">{pkg.Destination_Name}</h3>
                                                    {/* Jump to Map Shortcut */}
                                                    <button
                                                        onClick={() => {
                                                            document.getElementById('map-section')?.scrollIntoView({ behavior: 'smooth', block: 'start' });
                                                        }}
                                                        className="flex items-center gap-2 bg-white/20 hover:bg-white/30 backdrop-blur-md px-3.5 py-2 rounded-full text-xs font-normal transition-all border border-white/30 shadow-sm group-hover:bg-white/30"
                                                    >
                                            ...
                                            <div className="p-5 md:p-6 flex flex-col gap-5 bg-white relative">
                                                ...
                                                <div className="absolute -top-6 right-6 bg-gradient-to-r from-primary to-[#ff8a3d] text-white px-4 py-2 rounded-xl shadow-lg font-normal text-lg flex items-center gap-1 z-30 transform group-hover:scale-105 transition-transform border border-white/20">
                                                ...
                                                <div className="flex gap-3">
                                                    ...
                                                    <p className="text-gray-600 text-sm leading-relaxed font-medium line-clamp-2 md:line-clamp-3">
                                                        <span className="text-gray-900 font-normal">Why it's a match: </span>{pkg.matchReason.replace(/(^\w+:|^)\s*/, '')}
                                                    </p>
                                                </div>
                                                ...
                                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-1">
                                                    {(() => {
                                                        ...
                                                        return (
                                                            <button
                                                                ...
                                                                className="w-full flex items-center justify-center gap-2 py-2.5 sm:py-3 bg-[#f8f9fa] border-2 border-gray-200/60 text-gray-700 font-normal uppercase rounded-xl hover:bg-gray-100 hover:border-gray-300 hover:text-gray-900 transition-all shadow-sm text-[10px] sm:text-xs tracking-wide group"
                                                            >
                                                                <span>View Final Details</span>
                                                                <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-gray-400 group-hover:text-black transition-colors shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" /></svg>
                                                            </button>
                                                        );
                                                    })()}
                                                    ...
                                                    }} className="w-full relative overflow-hidden flex items-center justify-center py-2.5 sm:py-3 px-1.5 bg-gradient-to-r from-primary to-[#ff8a3d] text-white font-normal rounded-xl hover:from-[#e65c00] hover:to-[#e67300] transition-all shadow-md hover:shadow-lg text-[10px] sm:text-xs uppercase tracking-wide whitespace-nowrap group transform hover:scale-[1.02] active:scale-[0.98]">
                                                        <div className="absolute inset-0 bg-white/20 translate-y-full group-hover:translate-y-0 transition-transform duration-300 ease-out z-0"></div>
                                                        <span className="relative z-10 flex items-center gap-1.5 sm:gap-2">
                                                            Download Itinerary
                                                            <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 group-hover:translate-x-1 transition-transform shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M14 5l7 7m0 0l-7 7m7-7H3" /></svg>
                                                        </span>
                                                    </button>
                                                </div>
                                            </div>
                                        ...
                                        <div className="flex flex-col gap-4 shrink-0 mt-2">
                                                ...
                                                <div className="flex items-center gap-1.5 overflow-x-auto pb-2 scrollbar-hide px-1 w-full relative">
                                                    {itineraryItems.map((item, idx) => (
                                                        ...
                                                        >
                                                            ...
                                                            <span className="text-[9px] text-gray-400 font-normal uppercase tracking-widest group-hover:text-primary transition-colors relative z-10">Day</span>
                                                            <span className="text-base font-normal text-gray-800 tracking-tight mt-[-2px] relative z-10">{idx + 1}</span>
                                                        </button>
                                                    ))}
                                                </div>
                                            )}
                                            ...
                                            <div className="absolute top-4 right-4 z-10 flex gap-2">
                                                <button
                                                    ...
                                                    className="bg-white/90 backdrop-blur-md px-3 py-1.5 rounded-full text-gray-700 text-[10px] font-normal tracking-widest uppercase hover:bg-white hover:scale-105 transition-all flex items-center gap-2 border border-gray-100 shadow-sm"
                                                >
                                                ...
                                                <div className="bg-black/60 backdrop-blur-md px-3 py-1.5 rounded-full text-white text-[10px] font-normal tracking-widest uppercase opacity-0 group-hover:opacity-100 transition-opacity flex items-center gap-2 border border-white/20 pointer-events-none">
                ...
                {isMapExpanded && (
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="absolute bottom-6 left-1/2 -translate-x-1/2 bg-white/90 backdrop-blur-md px-6 py-3 rounded-full border border-gray-200 shadow-lg text-sm font-normal text-gray-800 pointer-events-none">
            ...
            <AnimatePresence>
                {isTransitioning && (
                    ...
                    >
                        ...
                        <h2 className="mt-8 text-2xl font-normal text-[#ff8a3d] animate-pulse tracking-widest uppercase">Ready for Takeoff</h2>
                    </motion.div>
                )}
            </AnimatePresence>
...
function ScrollLinkedItinerary({ itineraryItems }: { itineraryItems: { day: string; title: string; description: string }[] }) {
    ...
    return (
        <motion.div ref={containerRef} id="itinerary-section" variants={slideUpItem} className="bg-white/95 backdrop-blur-xl rounded-[2rem] p-5 md:p-6 shadow-[0_12px_44px_rgba(0,0,0,0.08)] border border-gray-100 flex flex-col shrink-0">
            <h4 className="text-xl font-normal text-gray-800 mb-6 flex items-center gap-3">
                ...
                <div className="relative border-l-2 border-dashed border-gray-200 ml-4 space-y-10 pb-4 h-full">
                    ...
                    {itineraryItems.map((item, idx) => (
                        <div key={idx} id={`itinerary-day-${idx}`} className="relative pl-10 pt-1 group">
                            ...
                            <h5 className="font-normal text-gray-800 text-base tracking-wide">{item.day}: <span className="font-normal text-gray-500">{item.title}</span></h5>
                            {item.description && (
