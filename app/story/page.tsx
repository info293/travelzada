...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Travelzada is a couple-focused travel company building thoughtful, fairly priced, and emotionally satisfying travel experiences.',
    type: 'website',
    url: 'https://www.travelzada.com/story',
    siteName: 'Travelzada',
    locale: 'en_US',
    images: [
      {
...
const jsonLd = {
  ...
  mainEntity: {
    ...
    foundingDate: '2023', // Assuming or approximate based on context if not known, purely illustrative or omit if unsure. User didn't give date. I'll omit date to be safe.
    address: {
      '@type': 'PostalAddress',
