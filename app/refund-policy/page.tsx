...
export default function RefundPolicyPage() {
    ...
    const webPageSchema = generateWebPageSchema({
        name: 'Refund Policy | Travelzada',
        description: 'Refund Policy for Travelzada services.',
        url: 'https://www.travelzada.com/refund-policy',
        websiteUrl: 'https://www.travelzada.com',
    })

    return (
        <main className="min-h-screen bg-white">
            <SchemaMarkup schema={breadcrumbSchema} id="breadcrumb-schema-refund" />
            <SchemaMarkup schema={webPageSchema} id="webpage-schema-refund" />
            <Header />
