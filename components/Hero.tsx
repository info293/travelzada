...
export default function Hero() {
  return (
    <section className="w-full bg-gradient-to-b from-cream via-white to-cream pt-32 pb-20 relative overflow-hidden">
      {/* Decorative elements */}
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <div className="inline-block">
              <span className="text-xs uppercase tracking-[0.2em] text-primary font-semibold bg-primary/10 px-4 py-2 rounded-full">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Link
                href="/destinations"
                className="inline-flex items-center justify-center bg-white border-2 border-primary text-primary px-10 py-5 rounded-full text-base font-semibold hover:bg-primary/5 transition-all duration-300"
              >
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-8 -left-8 bg-white shadow-2xl rounded-2xl px-8 py-6 border border-gray-100">
